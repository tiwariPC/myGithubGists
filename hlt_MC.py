# /dev/CMSSW_9_1_0/HLT/V13 (CMSSW_9_1_0_pre3)

import FWCore.ParameterSet.Config as cms

process = cms.Process( "HLTDeepCSV" )
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_9_1_0/HLT/V13')
)
...
process.datasets = cms.PSet(
  ...
  OnlineMonitor = ( cms.vstring( 'DST_CaloJet40_BTagScouting_v7',
    ...
    'HLT_HIL2Mu3Eta2p5_AK4CaloJet40Eta2p1ForPPRef_v4')+cms.vstring( 'HLT_HIL2Mu3Eta2p5_AK4CaloJet60Eta2p1ForPPRef_v4',
    'HLT_HIL2Mu3Eta2p5_AK4CaloJet80Eta2p1ForPPRef_v4',
    'HLT_HIL2Mu3Eta2p5_HIPhoton10Eta1p5ForPPRef_v4',
    'HLT_HIL2Mu3Eta2p5_HIPhoton15Eta1p5ForPPRef_v4',
    'HLT_HIL2Mu3Eta2p5_HIPhoton20Eta1p5ForPPRef_v4',
    ...
    'HLT_PFHT900_v6',
    'HLT_PFJet140_v8',
    'HLT_PFJet15_NoCaloMatched_v7')+cms.vstring( 'HLT_PFJet200_v8',
    'HLT_PFJet25_NoCaloMatched_v5',
    'HLT_PFJet260_v9',
    'HLT_PFJet320_v9',
    'HLT_PFJet400_v9',
...
#process.hltDeepCombinedSecondaryVertexBJetTagsPF = cms.EDProducer( "JetTagProducer",
#    jetTagComputer = cms.string( "hltCombinedSecondaryVertexV2" ),
#    tagInfos = cms.VInputTag( 'hltDeepBLifetimeTagInfosPF','hltDeepSecondaryVertexTagInfosPF' )
#)
...
process.HLT_QuadPFJet_BTagCSV_p016_VBF_Mqq460_v5 = cms.Path( process.HLTBeginSequence + process.hltPreQuadPFJetBTagCSVp016VBFMqq460 + process.HLTAK4CaloJetsSequence + process.hltQuadJet15 + process.hltTripleJet50 + process.hltDoubleJet65 + process.hltSingleJet80 + process.hltVBFCaloJetEtaSortedMqq150Deta1p5 + process.HLTBtagCSVSequenceL3 + process.hltBTagCaloCSVp022Single + process.HLTAK4PFJetsSequence + process.hltPFQuadJetLooseID15 + process.hltPFTripleJetLooseID64 + process.hltPFDoubleJetLooseID76 + process.hltPFSingleJetLooseID92 + process.HLTBtagCSVSequencePF + process.hltSelector6PFJets + process.hltBTagPFCSVp016SingleWithMatching + process.hltVBFPFJetCSVSortedMqq460Detaqq3p5 + process.HLTEndSequence )


process.HLTSchedule = cms.Schedule( (process.HLT_QuadPFJet_BTagCSV_p016_VBF_Mqq460_v5))
...
if 'hltTrigReport' in process.__dict__:
    process.hltTrigReport.HLTriggerResults                    = cms.InputTag( 'TriggerResults', '', 'HLTDeepCSV' )

if 'hltPreExpressCosmicsOutputSmart' in process.__dict__:
    process.hltPreExpressCosmicsOutputSmart.hltResults = cms.InputTag( 'TriggerResults', '', 'HLTDeepCSV' )

if 'hltPreExpressOutputSmart' in process.__dict__:
    process.hltPreExpressOutputSmart.hltResults        = cms.InputTag( 'TriggerResults', '', 'HLTDeepCSV' )

if 'hltPreDQMForHIOutputSmart' in process.__dict__:
    process.hltPreDQMForHIOutputSmart.hltResults       = cms.InputTag( 'TriggerResults', '', 'HLTDeepCSV' )

if 'hltPreDQMForPPOutputSmart' in process.__dict__:
    process.hltPreDQMForPPOutputSmart.hltResults       = cms.InputTag( 'TriggerResults', '', 'HLTDeepCSV' )

if 'hltPreHLTDQMResultsOutputSmart' in process.__dict__:
    process.hltPreHLTDQMResultsOutputSmart.hltResults  = cms.InputTag( 'TriggerResults', '', 'HLTDeepCSV' )

if 'hltPreHLTDQMOutputSmart' in process.__dict__:
    process.hltPreHLTDQMOutputSmart.hltResults         = cms.InputTag( 'TriggerResults', '', 'HLTDeepCSV' )

if 'hltPreHLTMONOutputSmart' in process.__dict__:
    process.hltPreHLTMONOutputSmart.hltResults         = cms.InputTag( 'TriggerResults', '', 'HLTDeepCSV' )

if 'hltDQMHLTScalers' in process.__dict__:
    process.hltDQMHLTScalers.triggerResults                   = cms.InputTag( 'TriggerResults', '', 'HLTDeepCSV' )
    process.hltDQMHLTScalers.processname                      = 'HLTDeepCSV'

if 'hltDQML1SeedLogicScalers' in process.__dict__:
    process.hltDQML1SeedLogicScalers.processname              = 'HLTDeepCSV'
...
_customInfo['inputFile' ]=  ['/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/0024D5C6-7108-E711-B853-FA163E6CF400.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/003B4C38-EF08-E711-AFA9-02163E011BD6.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/00856C97-5B0A-E711-B11A-0025905A48BA.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/009C2241-D307-E711-AFAB-02163E014331.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/00C45184-E208-E711-A09B-02163E01474F.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/0459D5E9-DE07-E711-B2C3-02163E01477B.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/049BAED4-D807-E711-834E-02163E01A4AD.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/0628C13B-D507-E711-8D9B-02163E01A509.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/06BE54BD-DE07-E711-931C-02163E0142AD.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/06DD3D2B-DC07-E711-A72B-02163E011E1D.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/06F5367F-7108-E711-8A85-FA163EB0D1BB.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/06FAEFB7-DE08-E711-9CFF-02163E014183.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/0867BE88-DF08-E711-8089-02163E014189.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/08CF8A01-D907-E711-94D9-02163E014761.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/08D6EF3C-EA08-E711-B52E-02163E019BE0.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/0A6C5639-EA08-E711-B5D2-02163E019D1A.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/0AD26EF4-DE07-E711-9C77-02163E01A6C7.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/0C3D82C6-0E08-E711-91DF-0CC47A4D75F8.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/0C58702B-D807-E711-83EE-02163E011BBA.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/0C5AA062-080A-E711-9EE0-0025905A60D2.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/FCA6E656-DE07-E711-B27A-02163E01440F.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/FCC28E18-E507-E711-AE23-02163E01A33B.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/FCC5CB8F-D807-E711-8711-02163E01473B.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/FCEA1E5C-EE07-E711-829C-02163E014436.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/FCF00FC9-E407-E711-9ABC-02163E01A551.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/FE0FD30E-D907-E711-859B-842B2B17F73D.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/FE244F5B-D307-E711-AE1C-02163E01A748.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/FE270707-E507-E711-AE74-02163E01376C.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/FE65F2F9-0E08-E711-9DD8-0025905A48EC.root', '/store/mc/PhaseIFall16DR/QCD_Pt-470to600_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/130000/FEBDD935-D507-E711-99B1-02163E01A643.root']
